...
export async function crearProducto(datos) {
  const sql = getSql();
  await sql`
    INSERT INTO productos (referencia, tipo, nombre, descripcion, peso, peso_cera, material_tipo, precio_base, material, medidas, tallas, imagenes, modelo_stl)
    VALUES (${datos.referencia}, ${datos.tipo}, ${datos.nombre}, ${datos.descripcion}, ${datos.peso}, ${datos.pesoCera}, ${datos.materialTipo}, ${datos.precioBase}, ${datos.material}, ${JSON.stringify(datos.medidas)}, ${JSON.stringify(datos.tallas)}, ${JSON.stringify(datos.imagenes)}, ${datos.modeloStl})
  `;
}
