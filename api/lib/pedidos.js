...
export async function crearPedido({ cliente, items, total, comprobanteUrl }) {
  ...
  await sql`
    INSERT INTO pedidos (id, cliente_nombre, cliente_whatsapp, cliente_ciudad, cliente_direccion, cliente_correo, items, total, estado, comprobante_url)
    VALUES (${id}, ${cliente.nombre}, ${cliente.whatsapp}, ${cliente.ciudad}, ${cliente.direccion}, ${cliente.correo}, ${JSON.stringify(items)}, ${total}, 'pendiente', ${comprobanteUrl || ""})
  `;
